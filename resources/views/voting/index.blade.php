...
<body class="bg-light d-flex align-items-center justify-content-center pt-5">
    <div class="container">
        <div class="position-relative mb-4">
            <h2 class="text-center mb-3">Silakan Pilih Kandidat {{ $election->name }}</h2>
            <form action="{{ route('logout') }}" method="GET" class="position-absolute top-0 end-0">
            ...
            @foreach ($candidates as $candidate)
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm p-4" style="width: 100%; max-width: 400px; height: 100%;">
                        <h4 class="text-center mb-4">{{ $candidate->name }}</h4>
                                ...
                                <a href="#" data-bs-toggle="modal"
                                    ...
                                    @if ($candidate->photo)
                                        <img src="{{ asset('storage/' . $candidate->photo) }}" class="rounded shadow-sm"
                                            alt="Foto Kandidat"
                                            style="max-height: 150px; max-width: 100%; object-fit: contain; cursor: pointer;">
                                    @else
                                        <img src="storage/photos/default.jpg" class="rounded shadow-sm"
                                            alt="Foto Kandidat"
                                            style="max-height: 150px; max-width: 100%; object-fit: contain; cursor: pointer;">
                                    @endif
                                </a>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-5 text-center mb-3">
                                        ...
                                        @else
                                            <img src="storage/photos/default.jpg" alt="Foto {{ $candidate->name }}"
